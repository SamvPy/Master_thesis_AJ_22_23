...
def main():
    ...
    model_grids = [(LogisticRegression(max_iter=10000), lr_l2_grid),
                   (SVC(), svc_grid), 
    ...
    for train, test in skf.split(X=data, y=targets):
        ...
        for (model, grid) in model_grids:
            ...
            uml.save_results(results_df, "VAE_evaluation_split_comparison") 
    ...
    # PXD splitter
    splitter = uml.ProjectBasedSplit(5, metadata=meta, on = "Group")
